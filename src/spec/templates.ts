 ...
 */
const basicTemplate: SpecTemplate = {
  id: 'basic',
  name: 'Basic',
 ...
 */
const featureTemplate: SpecTemplate = {
  id: 'feature',
  name: 'Feature',
 ...
 */
const bugTemplate: SpecTemplate = {
  id: 'bug',
  name: 'Bug Fix',
 ...
 */
const infrastructureTemplate: SpecTemplate = {
  id: 'infrastructure',
  name: 'Infrastructure',
 ...
 */
const apiTemplate: SpecTemplate = {
  id: 'api',
  name: 'API',
 ...
 */
export const templates: Record<SpecTemplateType, SpecTemplate> = {
  basic: basicTemplate,
 ...
 */
export function getTemplate(type: SpecTemplateType): SpecTemplate {
