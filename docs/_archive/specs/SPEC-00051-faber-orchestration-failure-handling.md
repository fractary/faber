...
| `plugins/faber/agents/fractary-faber-faber-manager.md` | Add Section 4.4 for handler execution |
| `plugins/faber/skills/fractary-faber-faber-state.md` | Add `update-step-remediation` operation |
