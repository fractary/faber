...
export type LogType = 'session' | 'build' | 'deployment' | 'test' | 'debug' | 'audit' | 'operational' | 'workflow';
...
export type LogStatus = 'active' | 'completed' | 'stopped' | 'success' | 'failure' | 'error';
