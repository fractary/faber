...
// Branch commands
const branchCommand = new commander_1.Command('branch')
...
branchCommand
    ...
    try {
        const manager = new repo_1.RepoManager();
...
exports.repoCommand.addCommand(branchCommand);
// PR commands
const prCommand = new commander_1.Command('pr')
...
exports.repoCommand.addCommand(prCommand);
// Status command
exports.repoCommand
    .command('status')
