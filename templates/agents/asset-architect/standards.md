...
- [ ] **MUST have** `model` field
  - Valid values: `claude-haiku-4-5`, `claude-sonnet-5`, `claude-opus-5`, `claude-sonnet-4-6`, `claude-opus-4-8`
  - Recommended: `claude-opus-5` for architects
...
- `plugins/faber/agents/fractary-faber-workflow-planner.md` - Creates execution plans
- `plugins/faber/skills/fractary-faber-architect/SKILL.md` - FABER architect phase
