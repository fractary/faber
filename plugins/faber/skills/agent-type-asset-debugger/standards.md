# Debugger Agent Standards

This document defines the standards and best practices for creating debugger agents.
...
Index structure:
{
  ...
  "categories": ["workflow", "build", "test", "deploy"],
...
Use this checklist for debugger quality:

- [ ] Context gathering covers all relevant sources
- [ ] KB search is performed before diagnosis
- [ ] Root cause is identified (not just symptoms)
- [ ] Solutions are specific and actionable
- [ ] Confidence levels are assessed
- [ ] Continuation commands are provided
- [ ] Findings are logged
- [ ] KB update mechanism exists
