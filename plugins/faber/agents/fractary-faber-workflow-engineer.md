---
name: fractary-faber-workflow-engineer
...
**Goal**: Determine which discovered commands/fractary-faber-agents/skills to integrate
...
- **Commands**:
  - `commands/fractary-faber-workflow-create.md` - Create new workflows
  - `commands/fractary-faber-workflow-update.md` - Update existing workflows
  - `commands/fractary-faber-workflow-inspect.md` - Validate workflow configuration
  - `commands/fractary-faber-workflow-run.md` - Execute workflows
- **Workflows**:
