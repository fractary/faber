---
name: fractary-faber-config-initializer
...
# faber/runs/ is committed to source control (plans, state files)
# .active-run-id is worktree-local state and must NOT be committed
