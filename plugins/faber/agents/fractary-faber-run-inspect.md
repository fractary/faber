...
state_path = getStatePath(run_id)  # Computes: .fractary/faber/runs/{run_id}/state.json
```
...
- **Commands**:
  - `commands/fractary-faber-workflow-run.md` - Start/resume workflows
  - `commands/fractary-faber-workflow-inspect.md` - Validate configuration
- **State Management**:
