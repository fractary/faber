...
/fractary-faber:config --context "enable autonomous mode"
/fractary-faber:config --context "change default branch to develop"

# Force overwrite without confirmation
/fractary-faber:config --force
```
</ARGUMENT_SYNTAX>
...
# FABER Configuration
# Generated by /fractary-faber:config
...
- `/fractary-faber-cloud:config` - Configure cloud infrastructure
</RELATED_COMMANDS>
