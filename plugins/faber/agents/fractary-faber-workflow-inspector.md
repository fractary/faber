---
name: fractary-faber-workflow-inspector
...
**Goal**: Verify that agents/fractary-faber-skills referenced in workflow steps exist and return proper FABER Response Format
...
PRINT "Found {len(agent_registry)} agents/fractary-faber-skills in registry"
if verbose:
...
**Output**:
- `agent_skill_validation`: Object with arrays of compliant, unknown, and not_found agents/fractary-faber-skills
...
💡 Agent/Skill Suggestions:
  ...
  → Add response format documentation to unknown agents/fractary-faber-skills
...
- **Commands**:
  - `commands/fractary-faber-init.md` - Initialize configuration
