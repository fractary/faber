...
allowed-tools: Agent(fractary-faber-session-saver)
model: claude-haiku-4-5
argument-hint: '[--run-id <id>] [--reason <reason>]'
---

Use **Agent** tool with `fractary-faber-session-saver` agent to save session metadata with provided arguments.
