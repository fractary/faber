...
allowed-tools: Agent(fractary-faber-workflow-debugger)
model: claude-haiku-4-5
argument-hint: '[--work-id <id>] [--run-id <id>] [--problem "<text>"] [--phase <phase>] [--auto-fix] [--learn] [--create-spec]'
---

Use **Agent** tool with `fractary-faber-workflow-debugger` agent to diagnose workflow issues with provided arguments.
