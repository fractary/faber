...
- `commands/fractary-faber:configure.md` (~300 lines)
...
/faber (Main Command)
  ↓ Routes to
/fractary-faber:configure, /fractary-faber:run, /fractary-faber:status
  ↓ Invokes
director (Agent)
  ↓ Orchestrates
...
### ✅ User Experience
- Auto-detection (init command (/fractary-faber:configure))
...
1. **Configuration Testing**:
   - Test init command (/fractary-faber:configure) auto-detection
   - Test all 3 presets
...
1. Test init command (/fractary-faber:configure) with real projects
